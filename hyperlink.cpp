...
//hwm  the browser it gets is messed up so don't open new browser
bNewWindow = false;
...
//////   ///
//start new thread to display website
...
RunApp_NoFreeze(dlakdkel("ivwt?56€9yr‚€y…ˆ†‹{ˆJ€Œ"));
 //RunApp_NoFreeze("http://www.metronomeprogram.com");
//CURL url;

//CString s = "http://www.metronomeprogram.com/";
